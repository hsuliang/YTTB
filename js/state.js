...
// --- 預設資料 ---
const THEMES = { 'old-newspaper': '老式報紙', 'caramel-pudding': '焦糖布丁', 'muji-style': '無印風格', 'black-and-white': '純粹黑白', 'blueberry-pancake': '藍莓鬆餅', 'lavender-field': '薰衣草田', 'mint-soda': '薄荷蘇打' };
const PRESET_CTAS = {
...
const PRESET_TAGS = ['AI教學', '數位工具', 'YouTube經營', '教育科技', 'Podcaster'];
