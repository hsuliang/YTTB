...
請參考 image3 海報中的來賓照片，將來賓設計成頭大身體小的 Q 版人物。

提示詞：
請生成一張 1:1 正方形社群輪播封面圖，主題為《Canva AI 開對了嗎》。整體畫面要溫暖、可愛、教育感、社群輪播風，帶有「居久屋微醺夜」下班後邊喝邊學的輕鬆微醺氛圍。請將 image1 的固定主持人 ㄚ亮笑長、image2 的固定小編 Alice、image3 海報中的本集來賓黃信溢老師／茶米老師，設計成頭大身體小的 Q 版人物，三人都要完整入鏡，不可裁切到臉、身體、手或腳。
場景設定在溫暖燈光的微醺夜教學酒館，背景有黑板、投影幕、筆電、簡報畫面與設定齒輪圖示。畫面中心要像一張社群輪播封面，有清楚留白，不要太擁擠。不要使用 Canva 官方商標圖形，可用簡潔的「Canva AI」文字作為平台名稱。
圖片中文字請使用繁體中文，文字少量、清楚、易讀，避免小字與雜亂背景文字。
主標題最大最醒目：Canva AI 開對了嗎
輔助短句：先弄懂入口與設定再開始創作
關鍵詞：設定｜版本｜開啟
CTA：看完這集，先檢查你的 Canva AI 有沒有真的開起來
整體情緒要像ㄚ亮笑長正在開場介紹今晚主題，Alice 拿著小編筆記本，茶米老師站在旁邊準備示範工具，畫面有微醺夜酒館的溫暖光區與教育科技感。這是一張單一且完整的圖片，絕對不要使用分割畫面、拼貼格、多圖組合或漫畫方格的形式 (single complete image, no split screen, no collage, no grid, no panels, no comic strip)。
